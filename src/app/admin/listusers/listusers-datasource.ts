...
const EXAMPLE_DATA: ListusersItem[] = [
...
export class ListusersDataSource extends DataSource<ListusersItem> {
  data: ListusersItem[] = EXAMPLE_DATA;
   ...
   */
  private getPagedData(data: ListusersItem[]): ListusersItem[] {
    if (this.paginator) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: ListusersItem[]): ListusersItem[] {
